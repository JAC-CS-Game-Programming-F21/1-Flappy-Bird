...
export default class Game {
	...
	update(dt) {
		...
		this.pipes.forEach((pipe, index) => {
			...
			// If the pipe is past the left edge, remove it from scene.
	...
	render() {
		...
		/**
		 * We pass the pipes into the scene so that we can render
		...
		context.fillText(`# Pipes: ${this.pipes.length}`, 15, 30);
